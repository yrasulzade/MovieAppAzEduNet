...
class VoteMovieUseCase @Inject constructor(private val voteMovieRepository: VoteMovieRepository) {
    suspend fun execute(voteMovieData: VoteMovieData) = voteMovieRepository.voteMovie(voteMovieData)
}